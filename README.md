...
Um dos maiores desafios enfrentados durante o desenvolvimento foi a integração da biblioteca Gson, utilizada para processar dados em formato JSON. Foi por meio dessa ferramenta que foi possível obter e manipular as informações atualizadas das moedas, viabilizando as conversões em tempo real de forma eficiente e automatizada.
